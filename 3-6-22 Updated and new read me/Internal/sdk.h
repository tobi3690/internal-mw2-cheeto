...
//namespace offsets {
//	auto ref_def_ptr = 0x12B76E78;
//	auto name_array = 0x12B961B0;
//	auto name_array_pos = 0x5E70;
//	auto loot_ptr = 0xB9A536C;
//	auto camera_base = 0x131AD600;
//	auto camera_pos = 0x1F8;
//	auto local_index = 0x101D10;
//	auto local_index_pos = 0x2D0;
//	auto recoil = 0xF381C;
//	auto game_mode = 0xF9D5EF8;
//	auto weapon_definitions = 0x12B094D0;
//	auto distribute = 0xB96EB88;
//	auto visible_offset = 0xA80;
//	auto visible = 0x258F660;
//	namespace player {
//		auto size = 0x6400;
//		auto valid = 0x60A8;
//		auto pos = 0x188;
//		auto team = 0xA19;
//		auto weapon_index = 0x61D8;
//		auto dead_1 = 0x1044;
//		auto dead_2 = 0x350;
//	}
//	namespace bone {
//		auto bone_base = 0xD8F90;
//		auto size = 0x188;
//		auto offset = 0xD8;
//	}
//}
...
namespace offsets
{
	constexpr auto ref_def_ptr = 0x12B76E78;
	constexpr auto name_array = 0x12B961B0;
	constexpr auto name_array_pos = 0x5E70;
	constexpr auto loot_ptr = 0xB9A536C;
	constexpr auto camera_base = 0x131AD600;
	constexpr auto camera_pos = 0x1F8;
	constexpr auto local_index = 0x101D10;
	constexpr auto local_index_pos = 0x2D0;
	constexpr auto recoil = 0xF381C;
	constexpr auto game_mode = 0xF9D5EF8;
	constexpr auto weapon_definitions = 0x12B094D0;
	constexpr auto distribute = 0xB96EB88;
	constexpr auto visible_offset = 0xA80;
	constexpr auto visible = 0x258F660;

	namespace player
	{
		constexpr auto stance = 0x0;
		constexpr auto size = 0x6400;
		constexpr auto valid = 0x60A8;
		constexpr auto pos = 0x188;
		constexpr auto team = 0xA19;
		constexpr auto weapon_index = 0x61D8;
		constexpr auto dead_1 = 0x1044;
		constexpr auto dead_2 = 0x350;
	}
	namespace bones
	{
		constexpr auto bone_base = 0xD8F90;
...
//namespace bones
//{
//	constexpr auto bone_base_pos = 0xD8F90;
//	constexpr auto size = 0x188;
//	constexpr auto visible = 0x258F660; // OK
//
//	constexpr auto distribute = 0xB96EB88; // OK
//}
//
//namespace view_port
//{
//	constexpr auto refdef_ptr = 0x12B76E78; // OK
//	constexpr auto camera_ptr = 0x131AD600; // OK
...
//{
//
//	constexpr auto name_array = 0x12B961B0;// ok 
